...
@Module({
    imports: [ConfigModule, IntegrationModule, BotModule, PrismaModule, MetaChatCursorModule, AudioTranscriptionModule, MetaLoopGuardModule, MetaAiDisclosureModule, EventsModule],
